...
class CartesianImpedanceTrajectoryController : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  ros::NodeHandle dynamic_reconfigure_cartesian_impedance_trajectory_param_node_;
  void cartesianImpedanceTrajectoryParamCallback(
